...
public class PATHQL {
	...
	public static final String EDGESTRING = "Edge";
	public static final String EDGE_TARGETSTRING = "edge.Target";
	public static final String EDGE_SOURCESTRING = "edge.Source";
