...
public class IReifications implements com.inova8.intelligentgraph.repositoryContext.Reifications{
	private static final Logger logger   = LoggerFactory.getLogger(IReifications.class);
	...
	public IReifications(IntelligentGraphRepository pathQLRepository) {
