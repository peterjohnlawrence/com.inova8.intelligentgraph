...
@Deprecated
public class PathQLBindingSetResults extends ResourceBindingSetResults {
	 ...
	 */
	public PathQLBindingSetResults(CloseableIteration<BindingSet, QueryEvaluationException> matchSet) {
		super(matchSet);
	}
