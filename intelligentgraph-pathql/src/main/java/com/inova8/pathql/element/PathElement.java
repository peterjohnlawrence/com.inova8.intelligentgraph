...
import com.inova8.intelligentgraph.constants.PathConstants.Operator;
...
//	}
	...
	public PathTupleExpr pathPatternQuery(
			/*Thing thing, */Integer pathIteration,CustomQueryOptions customQueryOptions) {
	...
	public abstract PathTupleExpr pathPatternQuery(/*Thing thing, */ Variable sourceVariable, Variable predicateVariable, Variable targetVariable, CustomQueryOptions customQueryOptions);

	public abstract PathTupleExpr pathPatternQuery(/*Thing thing, */ Variable sourceVariable, Variable predicateVariable,  Variable targetVariable,
	...
	public PathTupleExpr boundPatternQuery(/*Thing thing, */Variable sourceVariable, Variable targetVariable) {
		if (getIsBound())
			return getLeftPathElement().boundPatternQuery(/*Thing thing, */ sourceVariable, targetVariable);
		else
			return null;
	};
