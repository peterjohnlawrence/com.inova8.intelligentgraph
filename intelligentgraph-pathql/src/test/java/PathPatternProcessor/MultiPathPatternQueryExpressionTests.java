...
class MultiPathPatternQueryExpressionTests {
	...
	void test_0() {
		try {
			...
			IriRefValueElement iriRefValueElement = PathParser.parseIriRef(repositoryContext, ":hasProductBatteryLimit");
			assertEquals
			("<http://default/hasProductBatteryLimit>" ,iriRefValueElement.toString());
