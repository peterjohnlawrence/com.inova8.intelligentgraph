...
public class CustomQueryOptions extends Hashtable<String, Value> {
	@Override
...
//				//TODO	customQueryOptions.put(customQueryOptionParameter,	Resource.create(pathQLRepository, literal(customQueryOptionValue), null));
//					customQueryOptions.put(customQueryOptionParameter,	 literal(customQueryOptionValue));
//			}
...
//	}
	...
	public void add(String key,Object value ) {
		if(value!=null) {
			...
			case "TemporalAccessorLiteral":
				//TODO this.put(key, Literal.create((Value) value));
				 this.put(key, (Value) value);
				break;
			case "Literal":
				//TODO this.put(key,(Literal)value);
				this.put(key, (Literal)value);
				break;
			case "SimpleIRI":
			case "NativeIRI":
				//TODO this.put(key, Thing.create((Value)value));
				this.put(key, (Value)value);
				break;
			default:
				//TODO put(key, Literal.create(literal(value)));
				put(key, literal(value));
			}
		}else {
			//TODO put(key, Literal.create(null));
			put(key, literal(""));
		}
		
		
	}
	public Value getInherited(String key) {
	...
	public String toString() {
		...
		Boolean first =true;
		for ( java.util.Map.Entry<String, Value> queryOption:this.entrySet()) {
			if(!first) {
				queryOptionsstring+="&";
			}else
				first=false;
